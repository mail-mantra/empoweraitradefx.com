        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="row">
                    <div class="dashboard-title-2">
                        <div class="caption-2">
                            <h2>Live Trade Investment Report</h2>
                            <p>Live Trade Investment Report</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-panel">
                <div class="row">
                    ...
                    $query = "SELECT m2.mem_code, m2.name, m1.* FROM member_package_update_log m1 
                    INNER JOIN member m2 ON m1.member_id=m2.member_id
			        WHERE m1.package_id=2 " . $sql_member . $search_with_date_range;
                                ...
                                <table class="table table-bordered table-hover table-dark">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Amount (<?php echo CURRENCY_NAME; ?>)</th>
                                            <!--<th>Topup Action</th>-->
                                            <th>Topup BY</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $r1['created_by']; ?></td>
                                                <?php /* ?><td class="text-center">
                                                    <?php
                                                    if ((strtotime($current_date) - strtotime(dmy($topup_date))) == 0) {
                                                    ?>
                                                        <a href="member-topup-delete?action=del&tid=<?php echo hash_encode($topup_id); ?>" class="btn btn-sm btn-primary m-1">Delete Topup</a>
                                                    <?php
                                                    }
                                                    ?>
                                                </td><?php */ ?>
                                        ...
                                        <tr style="font-weight: bold">
                                            ...
                                            <td colspan="2"><?php echo number_format($page_tot,2); ?></td>
                                        </tr>
                                        <tr style="font-weight: bold">
                                            <td colspan="3" class="text-right">All Total</td>
                                            <td colspan="2"><?php echo number_format($all_tot,2); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
