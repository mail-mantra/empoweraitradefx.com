...
$ref_code = '';
if (!empty($_GET['ref'])) {
    $ref_code = filter_var($_GET['ref'], FILTER_SANITIZE_STRING);
    # check for ref_code
    $ref_member_code = decrypt($ref_code);

    $con = $db->connect();
    $q = mysqli_query($con, "SELECT member_id from member where mem_code='" . $ref_member_code . "'");
    $con->close();
                        ...
                        <form id="frmAdd" action="referral-joinc" method="post">
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" name="intro" id="intro" class="form-control" value="<?php echo $ref_member_code; ?>" data-rule-required="true" readonly />
                                </div>
