        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="row">
                    <div class="dashboard-title-2">
                        <div class="caption-2">
                            <h2>Premium Signal Plan Investment Report</h2>
            ...
            <div class="table-panel">
                <div class="row">
                    ...
                    $query = "SELECT m1.*, m3.package_name FROM `member_signal_package_update_log` m1 INNER JOIN join_package_signal m3 ON m1.package_id=m3.id WHERE m1.`member_id`='" . $user_id . "' order by m1.id desc";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $r1['telegram_link']; ?></td>
