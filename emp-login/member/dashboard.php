        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="box">
                  ...
                  <h3><span class="business_ratio">...</span> <a href="#" data-value='business_ratio' class="clickBtn">Refresh</a></h3>
              ...
              <div class="col-md-3">
                <div class="box">
                  ...
                  <h3><span class="total_business">...</span> <a href="#" data-value='total_business' class="clickBtn">Refresh</a></h3>
              ...
              <div class="col-md-3">
                <div class="box">
                  ...
                  <h5><span class="cl-7"><?php echo CURRENCY_ICON . $fund_wallet ?></span>Fund Balance</h5>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="box">
                  ...
                  <h5><span class="cl-5"><?php echo CURRENCY_ICON . $working_wallet ?></span>Working Balance</h5>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="box">
                  ...
                  <h5><span class="cl-5"><?php echo CURRENCY_ICON . $working_wallet ?></span>Trading Profit Balance</h5>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="row d-block">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header d-flex justify-content-between" style="background: #3a1255;  color: #fff;">
                ...
                <div class="col-md-6">
                  <div class="caption">
                    ...
                    <a onclick="copyToClipboard('<?php echo $ref_link ?>');" title="Copy to clipboard">
                      <i class="fa fa-copy" style="font-size: 1.2em; cursor: copy; color:#21139b;"></i>
                    </a>
                    ...
                    <h5>
                      ...
                      <a href="mailto:?&subject=EmpowerTradefx&body=<?php echo $ref_link ?>"><img src="../web-assets/images/gmail_icon.png" alt="Gmail" style="width:25px;"></a>
                    </h5>
                  </div>
                </div>
