...
$page_name='view-transfer-working-myfund-wallet';
	...
	<div class="container">
    	<div class="col-lg-12">
        	<div class="row">
                <div class="dashboard-title-2">
                	<div class="caption-2">
                        <h2>View Transfer Working to Fund (Self)</h2>
                        <p>Transfer Working to Fund List</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-panel">
            <div class="row">    
				...
				$query = "select * from transfer_working_wallet_balance where from_member_id='".$user_id."' and amount>'0.00' ".$search_with_date_range;							
