...
$page_name='report-salary-income';

$income_type='PERFORMANCE_BONUS';
			    ...
			    ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            	<td colspan="2" align="right"><strong>Total (This Page)</strong></td>
                                <td><strong><?php echo CURRENCY_ICON . number_format($tot_gross,2); ?></strong></td>
                            </tr>
                            <tr>
                            	<td colspan="2" align="right"><strong>Total Gross (All)</strong></td>
                                <td><strong><?php echo CURRENCY_ICON . number_format($all_total_gross,2); ?></strong></td>
                            </tr>
                        </tbody>
                        </table>
