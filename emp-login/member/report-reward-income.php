...
$page_name='report-reward-income';
        ...
        <div class="table-panel">
            <div class="row">    
				...
				if(isset($_REQUEST['start_date']) && ($_REQUEST['end_date'])){
					$search_with_date_range = " AND (`reward_date` BETWEEN '".$start_date."' AND '".$end_date."') ";
				}
				else{
					$search_with_date_range = "";
				}
				
				$query = "select * from reward_achievement where member_id='".$user_id."' ".$search_with_date_range;							
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $no; ?>.</td>	
                                    <td><?php echo dmy($r1['reward_date']); ?></td>	
