        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="row">
                    <div class="dashboard-title-2">
                        <div class="caption-2">
                            <h2>Live Account Request List</h2>
                            <p>Report</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-panel">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-2 mb-4">
                            <a href="live-account-request" class="btn btn-sm btn-info">New Request</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    $query = "select * from live_account_request where member_id='" . $user_id . "' order by id desc";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    Broker Server Name: <?php echo $r1['broker_server_name']; ?><br>
                                                    User Name: <?php echo $r1['user_name']; ?><br>
                                                    Password: <?php echo $r1['password']; ?>
                                                </td>
                                                        ...
                                                        <div class="modal-dialog  modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <?php include('../ajax/live-account-payment-details.php'); ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
