...
$page_name='member-rank-log-report';
	...
	<div class="container">
        ...
        <div class="table-panel">
            <div class="row">    
               ...
               $query = "SELECT m1.* FROM salary_eligibility_log m1 inner join member_login m2 on m1.member_id = m2.member_id WHERE m1.member_id = '".$user_id."' ".$search_with_date_range;
			    ...
			    ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <ul class="pagination">
                            ...
                            if ($tot_page >= $next) {
                            ?>	
                                <li class="page-item"><a class="page-link" href="<?php echo $page_name; ?>?cp=<?php echo $next; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" id="pagination" title="Next Page"><?php echo "Next"; ?></a></li>
                                <li class="page-item"><a class="page-link" href="<?php echo $page_name; ?>?cp=<?php echo $tot_page; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" id="pagination" title="Last Page"><?php echo "Last"; ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
