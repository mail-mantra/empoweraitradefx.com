...
$page_name = 'report-roi-transaction';

$table = 'roi_wallet_transaction';
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="dashboard-title-2">
                        <div class="caption-2">
                            <h2>Trading Profit Wallet</h2>
                            <p>Trading Profit Wallet History</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="frmAdd" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="submit" id="submit" class="btn <?php echo $btn_type ?> col-md-2 col-sm-3">Search</button>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <table class="table table-bordered table-hover table-dark">
                                    ...
                                    <tbody>
                                        ...
                                        while ($r1 = mysqli_fetch_assoc($sql)) {
                                            ...
                                            $particulars = str_replace('LEVEL', 'Course', $particulars);
                                            $particulars = str_replace('INVESTMENT', 'Big Investment', $particulars);
                                            $particulars = str_replace('ROI', 'Own Investment', $particulars);
                                            $particulars = str_replace('REFERRAL_COMMISSION', 'Yearly Plan', $particulars);
                                            $particulars = str_replace('BONUS', 'Bonus', $particulars);
                                        ?>
                                            <tr>
                                                <td><?php echo $no; ?>.</td>
                                                <td><?php echo dmy($r1['txn_date']); ?></td>
                                                <td><?php echo $particulars; ?></td>
                                                <td><?php echo number_format($r1['gross'], 2); ?></td>
                                                <td><?php echo number_format($r1['admin_charge'], 2); ?></td>
                                                <td><?php echo number_format($r1['tds'], 2); ?></td>
                                                <td><?php echo number_format($r1['gross'] - ($r1['admin_charge'] + $r1['tds']), 2); ?></td>
                                                <td><?php echo number_format($r1['credit'], 2); ?></td>
                                                <td><?php echo number_format($r1['debit'], 2); ?></td>
                                                <td><?php echo number_format($r1['balance'], 2); ?></td>
                                            </tr>
                                        <?php
                                        }
                                        $all_total_gross = 0;
