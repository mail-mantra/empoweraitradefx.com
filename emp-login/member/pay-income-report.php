            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="dashboard-title">
                        ...
                        <div class="caption">
                            <h2>View Pay Working Voucher</h2>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!$r1['withwraw_status']) { ?>
                                                        <a href="working-withdraw-bep20?rdm=<?php echo hash_encode($r1['id']) ?>&action=pay" class="btn btn-primary btn-sm">Withdraw</a>
                                                    <?php } else {
                                                        echo "Withdraw Done.";
                                                    } ?>
                                                </td>
